            ...
            <div class="modal-body">
                <div class="box-body">
                    ...
                    <div class="row col-sm-12">
                        ...
                        <div class="form-group col-sm-6">
                            <label for="pic">Job Type/Management Type<span style="color: red;"> * </span>:</label>
                            <input type="text" class="form-control" id="job_type" name="job_type" required placeholder="Job Type/Management Type">
                        </div>
                    </div>
                    <div class="row col-sm-12">
                        <div class="form-group col-sm-6">
...
function getManualUploadedFiles(upload) {
    ...
    $(".uploaded_manualfiles ol").append("<li class='list-group-item'><a upload_id='"+upload.id+"' target='_blank' href='"+bsurl+"/manualfiles/"+upload.hash+"/"+upload.filename+"'>"+fileImage+"</a><a href='#' class='btn btn-xs btn-danger pull-right'><i class='fa fa-trash'></i></a></li>"); 
}
...
function getWorkflowUploadedFiles(upload) {
    ...
    $hinput.val(JSON.stringify(hiddenFIDs));
    var fileImage = upload.filename;
    $(".uploaded_workflowfiles ol").append("<li class='list-group-item'><a upload_id='"+upload.id+"' target='_blank' href='"+bsurl+"/workflowfiles/"+upload.hash+"/"+upload.filename+"'>"+fileImage+"</a><a href='#' class='btn btn-xs btn-danger pull-right'><i class='fa fa-trash'></i></a></li>"); 
}
