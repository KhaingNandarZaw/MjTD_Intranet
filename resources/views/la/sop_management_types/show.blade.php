...
<div id="page-content" class="profile2">
    <div class="bg-primary clearfix">
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h4 class="name">{{ $sop_management_type->$view_col }}</h4>
                    <div class="row stats">
        ...
        <div class="col-md-1 actions">
            @la_access("SOP_Management_Types", "edit")
                <a href="{{ url(config('laraadmin.adminRoute') . '/sop_management_types/'.$sop_management_type->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access
    ...
    <ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
        <li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/sop_management_types') }}" data-toggle="tooltip" data-placement="right" title="Back to SOP Management Types"><i class="fa fa-chevron-left"></i></a></li>
