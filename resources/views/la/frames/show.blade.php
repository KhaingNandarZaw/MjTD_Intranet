    ...
    <div class="bg-primary clearfix">
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h4 class="name">{{ $frame->$view_col }}</h4>
                    <div class="row stats">
        ...
        <div class="col-md-1 actions">
            @la_access("Frames", "edit")
                <a href="{{ url(config('laraadmin.adminRoute') . '/frames/'.$frame->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access
            
            @la_access("Frames", "delete")
                {{ Form::open(['route' => [config('laraadmin.adminRoute') . '.frames.destroy', $frame->id], 'method' => 'delete', 'style'=>'display:inline']) }}
