            ...
            <table id="example1" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $user->name }}</td>
                        <td>
                            <a href="{{ url(config('laraadmin.adminRoute') . '/create_new_tasks/'.$requested_task->id . '/edit') }}" class="btn btn-warning btn-xs" style="display:inline;padding:2px 5px 3px 5px;">Edit</i></a>
                            <a href="{{ url(config('laraadmin.adminRoute') . '/create_new_tasks/'.$requested_task->id . '/cancel') }}" class="btn btn-danger btn-xs" style="display:inline;padding:2px 5px 3px 5px;">Cancel</i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
